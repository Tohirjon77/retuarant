...
<head>
  ...
  <link rel="stylesheet" href="{{asset('dashboardstyle/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css')}}">
  <!-- iCheck -->
  ...
  <!-- summernote -->
  <link rel="stylesheet" href="{{asset('dashboardstyle/plugins/summernote/summernote-bs4.min.css')}}">
  <link rel="stylesheet" href="{{asset('dashboardstyle/main.css')}}">
</head>
...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <div class="preloader flex-column justify-content-center align-items-center">
      <img class="animation__shake" src="{{asset('dashboardstyle/dist/img/AdminLTELogo.png')}}" alt="AdminLTELogo" height="60" width="60">
    </div>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      <!-- Brand Logo -->
      <a href="{{route('restaurent.index')}}" class="brand-link">
        <img src="{{asset('dashboardstyle/dist/img/AdminLTELogo.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
          style="opacity: .8">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="image">
            <img src="{{asset('dashboardstyle/dist/img/user2-160x160.jpg')}}" class="img-circle elevation-2" alt="User Image">
          </div>
          <div class="info">
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="{{route('categories.index')}}" class="nav-link">
                <i class="nav-icon ion-android-apps"></i>
                <p>
                  Categories
                </p>
              </a>
            ...
            <li class="nav-item">
              <a href="{{route('rest_data.index')}}" class="nav-link">
  ...
  <script src="{{asset('dashboardstyle/plugins/jqvmap/maps/jquery.vmap.usa.js')}}"></script>
  <!-- jQuery Knob Chart -->
