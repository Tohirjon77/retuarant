...
@if ($message = Session::get('success'))
    ...
    @endif 
<form class="container w-75 pt-5" action="{{ route('galleries.update', $gallery->id) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
     <div class="row">
        <div class=" d-flex" >
            <div class="form-group w-50 mr-5 pt-5">
                <strong>Rasm:</strong>
                <input type="file" multiple name="image" class="form-control" placeholder="image">
            </div>
            <img width="150px" src="{{asset($gallery->image)}}" alt="">
