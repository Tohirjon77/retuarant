...
@section('content')
    ...
    <div  class="d-flex justify-content-center flex-column p-3">
        ...
        <div class="d-flex justify-content-between mt-3 mb-3">
            <a href="{{route('cat_desc.create')}}" type="button" class=" w-25 btn btn-primary mb-2 pt-2 d-inline">Malumot qo'shish</a>
        ...
        <table border="1px"  class="text-center table table-bordered bordered-primary w-100 ">
            ...
            <tbody>
                ...
                @foreach ($catdesc as $key=>$item)
                
                    <tr>
                        <td>{{$catdesc->firstItem() + $key}}</td>
                        <td>{{$item->name}}</td>
