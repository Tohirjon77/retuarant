...
<div class="container pl-5 pr-5 pt-2">
    ...
    @endif 
    {{-- Form start --}}
    <form action="{{route('team.store')}}" method="POST" class="pt-2 mb-5" enctype="multipart/form-data">
        @csrf
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" name="position" class="form-control" placeholder="Lavozim">
            </div>
        </div>
        <div class="form-row">
            <div class="form-group col-md-6">
                <label >Tavfsilotlar</label>
                <textarea class="d-block w-100 p-2"  name="description" rows="6"></textarea>
            </div>
            <div class="form-group col-md-6">
                <label>Rasm</label>
